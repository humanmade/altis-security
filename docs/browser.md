...
This should generally be sent, and your content type should always be set explicitly. If you need to disable it,
...
By default, WordPress will allow REST API requests from any origin. You can add a filter
